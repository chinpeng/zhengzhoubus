 ...
 */
package com.jpsycn.wggl.mobile.androidpn.xmpp.ssl;
...
public class SSLConfig {
    ...
    private final static Logger log = Logger.getLogger(SSLConfig.class);
    ...
    static {
    	 //classPath = SSLConfig.class.getResource("/");//weblogic
    	 classPath = SSLConfig.class.getResource("/");//tomcat
