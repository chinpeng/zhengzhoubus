 ...
 */
package com.jpsycn.wggl.mobile.androidpn.xmpp;

import org.apache.log4j.Logger;

import com.jpsycn.wggl.mobile.androidpn.MyApplicationContext;
...
public class XmppServer {
	...
	private final static Logger log = Logger.getLogger(XmppServer.class);
    ...
    public Object getBean(String beanName) {
       // return context.getBean(beanName);
    	return MyApplicationContext.getContext().getBean(beanName);
    }
