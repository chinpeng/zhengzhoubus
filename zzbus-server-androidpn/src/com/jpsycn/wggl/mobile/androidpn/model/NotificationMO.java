 ...
 * 
 */
package com.jpsycn.wggl.mobile.androidpn.model;
 ...
 */
@Entity
@Table(name = "wggl_androidpn_notification")
public class NotificationMO implements Serializable {
    ...
    @Column(name = "jid_resource", length = 64)
    ...
    private String status;//0: 未发送 1：已发送 2：已接收 3：已查看'"
