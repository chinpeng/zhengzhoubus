...
import com.loveplusplus.androidpn.LogUtil;
...
public class NotificationDetailsActivity extends Activity {
	...
	protected static final String VERSION_SERVICE = "VersionService";
    ...
    private View createView(final String title, final String message,
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if("apk".equals(uri.subSequence(uri.lastIndexOf(".")+1, uri.length()))){
                		intent = new Intent(callbackActivityPackageName+"."+VERSION_SERVICE);
