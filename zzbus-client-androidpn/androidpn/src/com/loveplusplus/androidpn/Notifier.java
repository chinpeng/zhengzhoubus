 ...
 */
package com.loveplusplus.androidpn;
...
public class Notifier {
	...
	private static  String NOTIFICATION_DETAIL_ACTIVITY ;

	private static String NOTIFICATION_DETAIL_CATEGORY ;
    ...
    public Notifier(Context context) {
        ...
        NOTIFICATION_DETAIL_CATEGORY=sharedPrefs.getString(Constants.PACKAGE_NAME, "");
        NOTIFICATION_DETAIL_ACTIVITY=NOTIFICATION_DETAIL_CATEGORY+".NotificationDetailsActivity";
    }
    ...
    public void notify(String notificationId, String apiKey, String title,
        ...
        if (isNotificationEnabled()) {
            ...
            Intent intent = new Intent(NOTIFICATION_DETAIL_ACTIVITY);
            intent.addCategory(NOTIFICATION_DETAIL_CATEGORY);
